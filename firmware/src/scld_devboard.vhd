...
INT <= '0' when INT_oe_o_s='1' else '1';
  ...
  ROMCS  <= ROMCS_o_s WHEN OE='1' else '1';
  ROSCS  <= ROSCS_o_s WHEN OE='1' else '1';
  EXROM  <= EXROM_o_s WHEN OE='1' else '1';
   EPROM_CE <= EPROM_CE_o_s WHEN OE='1' else '1';
