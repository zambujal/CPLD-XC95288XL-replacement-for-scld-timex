...
My last iteration of the PCB (work in progress...maybe). You might use 10uF on both rails 5v and 3.2v ... I really don't know why I changed from two caps at same value 10 uF, 10 uF is great for the two big caps... don't used electrolitic though "space"... I had to use smaller stuff, but in the end I guess ...I could had used bigger stuff to be easier to solder.
